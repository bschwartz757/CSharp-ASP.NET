...
// NOTE: You can use the "Rename" command on the "Refactor" menu to change the class name "CADonorRegisterService" in code, svc and config file together.
public class CADonorRegisterService : ICADonorRegisterService
{
    CommunityAssistEntities communityAssistDb = new CommunityAssistEntities();
